...
require  THEMESTEK_LIVIZA_DIR . 'demo-content-setup/one-click-demo/wordpress-importer/parsers.php';
 ...
 */
if ( class_exists( 'WP_Importer' ) ) {
class themestek_WP_Import extends WP_Importer {
		...
		foreach ( $this->posts as $post ) {
			...
			if ( ! empty( $post['comments'] ) ) {
				...
				foreach ( $post['comments'] as $comment ) {
					...
					$newcomments[$comment_id]['commentseta']          = isset( $comment['commentseta'] ) ? $comment['commentseta'] : array();
				...
				foreach ( $newcomments as $key => $comment ) {
					...
					if ( ! $post_exists || ! comment_exists( $comment['comment_author'], $comment['comment_date'] ) ) {
						...
						foreach( $comment['commentseta'] as $meta ) {
...
function wordpress_importer_init() {
	load_plugin_textdomain( 'wordpress-importer', false, get_template_directory() . '/includes/one-click-demo/wordpress-importer/languages' );
