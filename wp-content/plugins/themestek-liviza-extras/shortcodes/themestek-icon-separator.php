<?php
// [themestek-themestekiconseparator icon="search-1" style="dashed" width="70" el_class="customclass"]
...
function themestek_sc_icon_separator( $atts, $content=NULL ){
	...
	if( function_exists('vc_map') ){
		...
		global $themestek_sc_params_icon_separator;
		$options_list = themestek_create_options_list($themestek_sc_params_icon_separator);
		...
		$icon = '<i class="themestek-separatoc-icon '.${'icon_icon_'.$icon_type}.'"></i>';
		...
		// Separator
		$separator_code = '<div class="themestek-sep-with-icon-wrapper">';
...
add_shortcode( 'themestek-icon-separator', 'themestek_sc_icon_separator' );