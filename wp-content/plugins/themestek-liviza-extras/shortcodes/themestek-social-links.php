...
add_shortcode( 'themestek-social-links', 'themestek_sc_social_links' );
...
function themestek_get_social_links( $tooltip_position='top' , $tooltip='yes' ){
	...
	if( !empty($liviza_theme_options['social_icons_list']) ){
		foreach( $liviza_theme_options['social_icons_list'] as $socialicon ){
			...
			$return .= '<li class="themestek-social-' . $social_id . '"><a class=" ' . sanitize_html_class($class) . '" target="_blank" href="' . $href . '" ' . $data_tooltip . '><i class="themestek-liviza-icon-' . $social_id . '"></i></a></li>' . "\n";
