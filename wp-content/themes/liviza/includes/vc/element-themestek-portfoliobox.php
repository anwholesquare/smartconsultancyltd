...
if( taxonomy_exists('themestek-portfolio-category') ){
	$portfolioCatList_data = get_terms( 'themestek-portfolio-category', array( 'hide_empty' => false ) );
	$portfolioCatList      = array();
...
$allParams = array_merge(
		...
		array( 
			array(
				...
				"description" => sprintf( esc_html__("Show sortable category links above %s items so user can sort by just single click.",'liviza'), $pf_type_title_singular ),
				"param_name"  => "sortable",
				"value"       => array(
			...
			array(
				...
				"description" => sprintf( esc_html__("Show pagination links below %s boxes.",'liviza'), $pf_type_title ),
			...
			array(
				"type"        => "checkbox",
				"heading"     => sprintf( esc_html__("From %s", "liviza"), $pf_cat_title_singular ),
				"description" => sprintf( esc_html__('If you like to show %1$s from selected %2$s than select the category here.', 'liviza'), $pf_type_title, $pf_cat_title ),
				"param_name"  => "category",
			...
			array(
				...
				"description" => sprintf( esc_html__("How many %s item you want to show.", "liviza"), $pf_type_title ),
				"param_name"  => "show",
				"value"       => array(
...
$themestek_sc_params_portfoliobox = $params;
vc_map( array(
	"name"     => sprintf( esc_html__("ThemeStek %s Box",'liviza'), $pf_type_title_singular ),
	"base"     => "themestek-portfoliobox",
	"class"    => "",
