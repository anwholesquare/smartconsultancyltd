...
$service_type_title          = ( !empty($liviza_theme_options['service_type_title']) ) ? $liviza_theme_options['service_type_title'] : 'Service' ;
...
$service_cat_title           = ( !empty($liviza_theme_options['service_cat_title']) ) ? $liviza_theme_options['service_cat_title'] : 'Service Categories' ;
$service_cat_title_singular  = ( !empty($liviza_theme_options['service_cat_title_singular']) ) ? $liviza_theme_options['service_cat_title_singular'] : 'Service Category' ;
/**
 * Heading Element
 */
...
$allParams = array_merge(
		...
		array( 
			array(
				...
				"description" => sprintf( esc_html__("Show sortable category links above %s items so user can sort by just single click.",'liviza'), $service_type_title_singular ),
				"param_name"  => "sortable",
				"value"       => array(
			...
			array(
				...
				"description" => sprintf( esc_html__("Show pagination links below %s boxes.",'liviza'), $service_type_title ),
			...
			array(
				"type"        => "checkbox",
				"heading"     => sprintf( esc_html__("From %s", "liviza"), $service_cat_title_singular ),
				"description" => sprintf( esc_html__('If you like to show %1$s from selected %2$s than select the category here.', 'liviza'), $service_type_title, $service_cat_title ),
				"param_name"  => "category",
			...
			array(
				...
				"description" => esc_html__("Sort retrieved service by parameter.",'liviza'),
				"param_name"  => "orderby",
				"value"       => array(
			...
			array(
				...
				"description" => sprintf( esc_html__("How many %s item you want to show.", "liviza"), $service_type_title ),
				"param_name"  => "show",
				"value"       => array(
...
vc_map( array(
	"name"     => sprintf( esc_html__("ThemeStek %s Box",'liviza'), $service_type_title_singular ),
