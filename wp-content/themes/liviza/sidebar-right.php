...
if( is_page() ){
	...
	$sidebar_right      = 'sidebar-right-coaching';
	$sidebar_right_page = get_post_meta( get_the_ID(), '_themestek_metabox_sidebar', true );
	if( !empty($sidebar_right_page['right_sidebar']) ){ $sidebar_right = $sidebar_right_page['right_sidebar']; }
	...
	$sidebar_right_page = get_post_meta( get_the_ID(), '_themestek_metabox_sidebar', true );
	if( !empty($sidebar_right_page['right_sidebar']) ){ $sidebar_right = $sidebar_right_page['right_sidebar']; }
} elseif( is_tax('themestek-portfolio-category') ) {  // Portfolio category
	$sidebar_right      = 'sidebar-right-portfoliocat';
} elseif( is_tax('themestek-coaching-category') ) {  // Coaching category
	$sidebar_right      = 'sidebar-right-coachingcat';
} elseif( is_tax('themestek-service-category') ) {  // Service category
...
} elseif( is_tax('themestek-team-group') ) {  // Team Member Group
	...
	$sidebar_right      = 'sidebar-right-timetable';
	$sidebar_right_page = get_post_meta( get_the_ID(), '_themestek_metabox_sidebar', true );
