...
<div class="themestek-fid inside themestek-fid-boxstyle-without-icon <?php echo themestek_sanitize_html_classes($themestek_global_fid_element_values['main-class']); ?>">
	<div class="themestek-fld-contents">
		<div class="themestek-ihbox-icon">
			<?php echo themestek_wp_kses($themestek_global_fid_element_values['icon_html'], 'sbox_icon'); ?>
			<?php echo themestek_wp_kses($themestek_global_fid_element_values['before_text']); ?>
		</div>
		<div class="themestek-fid-inner">
			...
			<?php echo themestek_wp_kses($themestek_global_fid_element_values['after_text']); ?>
		</div>
	...
	<div class="themestek-fid-desc">	
		<p><?php echo esc_html($themestek_global_fid_element_values['desc']); ?> </p>
	</div>
</div>
<?php
	endif;
