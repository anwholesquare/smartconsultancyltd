...
<div class="themestek-ptablebox themestek-ptablebox-<?php echo themestek_sanitize_html_classes($themestek_global_ptbox_element_values['boxstyle']); ?> <?php echo themestek_sanitize_html_classes($themestek_global_ptbox_element_values['main-class']); ?>">
	...
	<div class="themestek-ptablebox-colum themestek-ptablebox-pricebox">
		...
		<div class="themestek-ptable-price-w themestek-skincolor">
	...
	<div class="themestek-ptablebox-colum themestek-ptablebox-button">
		<?php if( !empty($themestek_global_ptbox_element_values['btn_title']) ){ ?>
			<?php echo do_shortcode('[themestek-btn title="'.esc_attr($themestek_global_ptbox_element_values['btn_title']).'" link="'.esc_attr($themestek_global_ptbox_element_values['btn_link']).'"]'); ?>
		<?php } ?>
	</div>
</div>
<?php
